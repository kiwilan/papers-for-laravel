...
class Directory
{
     ...
     */
    public function ensureFileExists(string $path, bool $recreate = true): void
    {
     ...
     * @return SplFileInfo[]
     */
    public function parseFileInfo(string $directory, array|false $ignore = ['.gitignore', '.DS_Store', '$RECYCLE.BIN']): array
    {
        $files = [];
